...
pub mod did_contract {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions: ::core::convert::From::from([
                (
                    ::std::borrow::ToOwned::to_owned("del"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            name: ::std::borrow::ToOwned::to_owned("del"),
                            inputs: ::std::vec![],
                            outputs: ::std::vec![],
                            constant: ::core::option::Option::None,
                            state_mutability: ::ethers::core::abi::ethabi::StateMutability::NonPayable,
            ...
            events: ::core::convert::From::from([
                (
                    ::std::borrow::ToOwned::to_owned("Deleted"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Event {
                            name: ::std::borrow::ToOwned::to_owned("Deleted"),
                            inputs: ::std::vec![
                                ::ethers::core::abi::ethabi::EventParam {
                                    name: ::std::string::String::new(),
                                    kind: ::ethers::core::abi::ethabi::ParamType::Address,
    ...
    #[rustfmt::skip]
    const __BYTECODE: &[u8] = b"`\x80`@R4\x80\x15a\0\x10W`\0\x80\xFD[Pa\x07\x9E\x80a\0 `\09`\0\xF3\xFE`\x80`@R4\x80\x15a\0\x10W`\0\x80\xFD[P`\x046\x10a\0AW`\x005`\xE0\x1C\x80cN\xE5\xC2\xEE\x14a\0FW\x80c\xB6X\x8F\xFD\x14a\0[W\x80c\xC2\xBC.\xFC\x14a\0cW[`\0\x80\xFD[a\0Ya\0T6`\x04a\x02\xF5V[a\0\x8CV[\0[a\0Ya\x01vV[a\0va\0q6`\x04a\x03mV[a\x01\xC6V[`@Qa\0\x83\x91\x90a\x03\x9DV[`@Q\x80\x91\x03\x90\xF3[3`\0\x90\x81R` \x81\x81R`@\x91\x82\x90 \x91Qa\0\xAB\x91\x83\x91\x01a\x04:V[`@Q` \x81\x83\x03\x03\x81R\x90`@R\x80Q\x90` \x01 \x84\x84`@Q` \x01a\0\xD4\x92\x91\x90a\x04\xB0V[`@Q` \x81\x83\x03\x03\x81R\x90`@R\x80Q\x90` \x01 \x14a\0\xFDW\x80a\0\xFB\x84\x86\x83a\x05'V[P[\x80`\x01\x01T\x82\x14a\x01\x10W`\x01\x81\x01\x82\x90U[3`\0\x90\x81R` \x81\x90R`@\x90 \x81\x90\x80a\x01,\x83\x82a\x05\xE8V[P`\x01\x91\x82\x01T\x91\x01U`@Q3\x90\x7F>\xEB\xA0\xD9\xA1\xE8\xCEiU\xA02m(Ey\xC3\x1FO\xB1 \xB0\rf\x86\xE2\x01:h?\xAC\xD8y\x90a\x01h\x90\x84\x90a\x06\xC5V[`@Q\x80\x91\x03\x90\xA2PPPPV[3`\0\x90\x81R` \x81\x90R`@\x81 \x90a\x01\x90\x82\x82a\x02\x9FV[P`\0`\x01\x91\x90\x91\x01\x81\x90U`@Q3\x91\x7F\x7F\xB2\xE4\x9Cm-\xCCt\x8C\xCE\xD4\xBE@M\xF4\xB5\x02\xA5\t\x1D\x84\xF3/b\xFAx!\xB5\xF9#\x1Fk\x91\xA2V[`@\x80Q\x80\x82\x01\x90\x91R``\x81R`\0` \x82\x01R`\x01`\x01`\xA0\x1B\x03\x82\x16`\0\x90\x81R` \x81\x90R`@\x90\x81\x90 \x81Q\x80\x83\x01\x90\x92R\x80T\x82\x90\x82\x90a\x02\x0C\x90a\x04\0V[\x80`\x1F\x01` \x80\x91\x04\x02` \x01`@Q\x90\x81\x01`@R\x80\x92\x91\x90\x81\x81R` \x01\x82\x80Ta\x028\x90a\x04\0V[\x80\x15a\x02\x85W\x80`\x1F\x10a\x02ZWa\x01\0\x80\x83T\x04\x02\x83R\x91` \x01\x91a\x02\x85V[\x82\x01\x91\x90`\0R` `\0 \x90[\x81T\x81R\x90`\x01\x01\x90` \x01\x80\x83\x11a\x02hW\x82\x90\x03`\x1F\x16\x82\x01\x91[PPPPP\x81R` \x01`\x01\x82\x01T\x81RPP\x90P\x91\x90PV[P\x80Ta\x02\xAB\x90a\x04\0V[`\0\x82U\x80`\x1F\x10a\x02\xBBWPPV[`\x1F\x01` \x90\x04\x90`\0R` `\0 \x90\x81\x01\x90a\x02\xD9\x91\x90a\x02\xDCV[PV[[\x80\x82\x11\x15a\x02\xF1W`\0\x81U`\x01\x01a\x02\xDDV[P\x90V[`\0\x80`\0`@\x84\x86\x03\x12\x15a\x03\nW`\0\x80\xFD[\x835g\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\x80\x82\x11\x15a\
g\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\x81\x11\x15a\x06\x15Wa\x06\x15a\x04\xC0V[a\x06)\x81a\x06#\x84Ta\x04\0V[\x84a\x04\xD6V[`\0`\x1F\x82\x11`\x01\x81\x14a\x06]W`\0\x83\x15a\x06EWP\x84\x82\x01T[`\0\x19`\x03\x85\x90\x1B\x1C\x19\x16`\x01\x84\x90\x1B\x17\x84Ua\x05\xE1V[`\0\x85\x81R` \x90 `\x1F\x19\x84\x16\x90`\0\x86\x81R` \x90 \x84[\x83\x81\x10\x15a\x06\x97W\x82\x86\x01T\x82U`\x01\x95\x86\x01\x95\x90\x91\x01\x90` \x01a\x06wV[P\x85\x83\x10\x15a\x06\xB5W\x81\x85\x01T`\0\x19`\x03\x88\x90\x1B`\xF8\x16\x1C\x19\x16\x81U[PPPPP`\x01\x90\x81\x1B\x01\x90UPV[`\0` \x80\x83R`@` \x84\x01R`\0\x84Ta\x06\xE0\x81a\x04\0V[\x80``\x87\x01R`\x80`\x01\x80\x84\x16`\0\x81\x14a\x07\x02W`\x01\x81\x14a\x07\x1EWa\x07NV[`\xFF\x19\x85\x16`\x80\x8A\x01R`\x80\x84\x15\x15`\x05\x1B\x8A\x01\x01\x95Pa\x07NV[\x89`\0R` `\0 `\0[\x85\x81\x10\x15a\x07EW\x81T\x8B\x82\x01\x86\x01R\x90\x83\x01\x90\x88\x01a\x07*V[\x8A\x01`\x80\x01\x96PP[PPPPP`\x01\x85\x01T`@\x85\x01R\x80\x92PPP\x92\x91PPV\xFE\xA2dipfsX\"\x12 S\x12`\x83I\xB4w\x12\xB2\xB6\xA3$.29\xCDV\x0387;z\xCD[\x92\x88\r\xA0:\x0B\xA9\xAAdsolcC\0\x08\x16\x003";
    /// The bytecode of the contract.
    ...
    impl<M: ::ethers::providers::Middleware> DIDContract<M> {
        ...
        ///Calls the contract's `del` (0xb6588ffd) function
        pub fn del(&self) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([182, 88, 143, 253], ())
                .expect("method not found (this should never happen)")
        }
        ...
        ///Gets the contract's `Deleted` event
        pub fn deleted_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, DeletedFilter> {
            self.0.event()
        }
    ...
    #[ethevent(name = "Deleted", abi = "Deleted(address)")]
    pub struct DeletedFilter(#[ethevent(indexed)] pub ::ethers::core::types::Address);
    #[derive(
        Clone,
        ::ethers::contract::EthEvent,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::contract::EthLogDecode for DIDContractEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = DeletedFilter::decode_log(log) {
                return Ok(DIDContractEvents::DeletedFilter(decoded));
            }
    ...
    impl ::core::fmt::Display for DIDContractEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::DeletedFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::UpdatedFilter(element) => ::core::fmt::Display::fmt(element, f),
            }
        }
    }
    impl ::core::convert::From<DeletedFilter> for DIDContractEvents {
        fn from(value: DeletedFilter) -> Self {
            Self::DeletedFilter(value)
        }
    }
    ...
    ///Container type for all input parameters for the `del` function with signature `del()` and selector `0xb6588ffd`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::core::abi::AbiDecode for DIDContractCalls {
        fn decode(
            ...
            let data = data.as_ref();
            if let Ok(decoded) = <DelCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::Del(decoded));
            }
            if let Ok(decoded) = <GetCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
    ...
    impl ::ethers::core::abi::AbiEncode for DIDContractCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                Self::Del(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::Get(element) => ::ethers::core::abi::AbiEncode::encode(element),
    ...
    impl ::core::fmt::Display for DIDContractCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::Del(element) => ::core::fmt::Display::fmt(element, f),
                Self::Get(element) => ::core::fmt::Display::fmt(element, f),
                Self::Update(element) => ::core::fmt::Display::fmt(element, f),
            }
        }
    }
    impl ::core::convert::From<DelCall> for DIDContractCalls {
        fn from(value: DelCall) -> Self {
            Self::Del(value)
        }
    }
