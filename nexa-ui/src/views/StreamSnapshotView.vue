...
<template>
  ...
  <div v-else>
    <h1 class="center">Enjoy your photo!</h1>
    <div class="margin">
      <Picture
        :src="snapshot"
  ...
  <div class="button-container">
    ...
    <button @click="downloadImage" v-if="rawImage" class="large">Download</button>
      -->
    <a v-if="rawImage" href="/photo.jpg" class="button-link-large">Download</a>
  </div>
  <div class="button-container">
  ...
  <div v-if="rawImage" class="margin">
    <p>Photo was validated using smart contract on Lisk L2 network.
    You can check the hash in <a
